...
export function UserLocationMarker({ position }: { position: UserLocation["position"] }) {
  if (!position) return null

  return (
    <span
      className="absolute size-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500 ring-4 ring-blue-500/30"
