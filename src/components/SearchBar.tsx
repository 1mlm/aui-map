...
import { InputGroup, InputGroupAddon, InputGroupInput, InputGroupText } from "@/shadcn/ui/input-group"
...
export function SearchBar({
  ...
  return (
    <InputGroup {...{ className }}>
      ...
      <InputGroupInput {...{ placeholder }} value={search} onChange={(e) => setSearch(e.target.value)} />
      {trailing && (
